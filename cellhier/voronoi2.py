...
# colors = [sns.color_palette('bright')[i] for i in spot_samp['neighborhood10']]
    ...
    return areas
def draw_voronoi_scatter(spot,c,palette = sns.color_palette('bright'),X = 'X:X', Y = 'Y:Y',hue = 'neighborhood10',
        figsize = (5,5),
         voronoi_kwargs = {},
         scatter_kwargs = {}):
    '''
